...
class Mail {
	...
	public function getPrecedenceString() {
		switch($this->precedence) {
			case static::PRECEDENCE_BULK: return 'bulk';
			case static::PRECEDENCE_JUNK: return 'junk';
			case static::PRECEDENCE_LIST: return 'list';
			default: return null;
		}
	}
	...
	public function getPriorityString() {
		switch($this->priority) {
			case static::PRIORITY_HIGHEST: return '1 (Highest)';
			case static::PRIORITY_HIGH: return '2 (High)';
			case static::PRIORITY_LOW: return '4 (Low)';
			case static::PRIORITY_LOWEST: return '5 (Lowest)';

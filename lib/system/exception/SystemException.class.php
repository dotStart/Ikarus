	...
	public function showMinimal () {
		...
		<div class="systemException">
			...
			<div>
				...
				<h2>
					<a href="javascript:void(0);" onclick="$('#stacktrace').toggle('blind'); $(this).text(($(this).text() == '+' ? '-' : '+'));">+</a>Stacktrace
				</h2>
				...
				<h2>
					<a href="javascript:void(0);" onclick="$('#definedConstants').toggle('blind'); $(this).text(($(this).text() == '+' ? '-' : '+'));">+</a>Constants (<?php echo count (get_defined_constants (true)); ?>)
				</h2>
						<pre id="definedConstants" style="display: none;"><?php $constants = get_defined_constants (true);
				...
				<h2>
					<a href="javascript:void(0);" onclick="$('#extensions').toggle('blind'); $(this).text(($(this).text() == '+' ? '-' : '+'));">+</a>Extensions (<?php echo count (get_loaded_extensions ()); ?>)
				</h2>
				<pre id="extensions" style="display: none;"><?php $extensions = get_loaded_extensions ();
					asort ($extensions);

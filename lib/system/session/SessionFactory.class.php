...
class SessionFactory {
	...
	public static function createSession ($sessionID, $abbreviation, $packageID, $environment) {
		...
		if ($event->isCancelled () and $event->getReplacement () === null) throw new MissingDependencyException('No replacement has been supplied to %s', 'CreateSessionEvent'); elseif ($event->isCancelled ()) $instance = $event->getReplacement ();

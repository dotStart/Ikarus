 ...
 * @version		2.0.0-0001
 */
class AdapterEventArguments extends AbstractEventArguments {

	/**
	 * Constructs the object.
	 * @param			IFilesystemAdapter			$adapter
	 */
	public function __construct(IFilesystemAdapter $adapter) {
		$this->content['adapter'] = $adapter;
	}
}
?>
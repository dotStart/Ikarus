...
/**
 * This is the base class for all cancellable dispatcher events.
...
abstract class CancellableRequestDispatcherEvent extends AbstractCancellableEvent implements IRequestDispatcherEvent {
	 ...
	 * @param			DispatcherEventArguments			$arguments
	 */
	public function __construct(DispatcherEventArguments $arguments) {

...
class TemplatePatchUnified {
	...
	/**
	 * Current byte position in the 'in' file -- important for the calling class!
	 * @var		integer
	 */
	public $i_pos			= 0;
	...
	/**
	 * Another filehandle for output.
	 * @var		resource
	 */
	protected $o_fh			= null;
	
	/**
	 * Input filehandle (the original file that's about to be patched).
	 * @var		resource
	 */
	protected $i_fh			= null;
	
	/**
	 * The type of linebreaks being used in the original file.
	 * @var		array<string>
	 */
	protected $newLine		= array();
	
	/**
	 * The path to original file
	 * @var		string
	 */

...
class TemplatePatch {
	/**
	 * The ID of the package that initiates this process
	 * @var		integer
	 */
	protected $packageID		= 0;
	
	/**
	 * The ID of the template that's to be patched.
	 * @var		integer
	 */
	...
	/**
	 * Lines that are neither context nor diff lines.
	 * @var		array<string>
	 */
	protected $garbage		= array();
	
	/**
	 * Where the completed patches will be stored.
	 * @var		array<string>
	 */
	protected $patch		= array();
	
	/**
	 * The number of the patch (there might be multiple patches within a diff).
	 * @var		integer
	 */
	protected $patchNo		= 0;
	
	/**
	 * Byte position in the original file.
	 * @var		integer
	 */
	protected $targetPosition	= 0;
	
	/**
	 * A regex that checks the first two lines of each diff.
	 * @var		string
	 */
	protected $regexCheckFile	= '';
	
	/**
	 * The name of the working temp file.
	 * @var		string
	 */
	protected $tempOutputFile	= '';
	
	/**
	 * If it is a patch or a reverse patch.
	 * @var		boolean
	 */
	protected $reverse		= false;
	
	/**
	 * The fuzziness that may be applied to the patching algorithm.
	 * @var		integer
	 */
	protected $fuzzFactor		= 0;
	
	/**
	 * The filehandle for the original file.
	 * @var		resource
	 */
	protected $inputFileHandle	= null;
	
	/**
	 * The filehandle for the output file.
	 * @var		resource
	 */
	protected $outputFileHandle	= null;
	
	/**
	 * An object instance of the class that actually applies the unidiff.
	 * @var		TemplatePatchUnified
	 */
	protected $templatePatchUnified	= null;
	
	/**
	 * The path to original template file
	 * @var		string
	 */

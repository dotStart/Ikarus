...
class Template {
	...
	/**
	 * Contains the current set language identifier
	 * @var		integer
	 */
	protected $languageID = 0;
	
	/**
	 * Contains the paths where the templates are located
	 * @var		array<string>
	 */
	protected $templatePaths;
	
	/**
	 * Contains the path where all plugins are located
	 * @var		string
	 */
	protected $pluginDir;
	
	/**
	 * Contains the path where our compiled templates should be stored
	 * @var		string
	 */
	protected $compileDir;
	
	/**
	 * Contains true if all templates should compiled at runtime
	 * @var		boolean
	 */
	protected $forceCompile = false;
	
	/**
	 * Contains a list of prefilters
	 * @var		array
	 */
	protected $prefilters = array();
	
	/**
	 * Contains an instance of TemplateCompiler
	 * @var		TemplateCompiler
	 */
	protected $compilerObj = '';
	
	/**
	 * Contains assigned variables
	 * @var		array
	 */
	protected $v = array();
	
	/**
	 * Contains the cached template structure
	 * @var		array
	 */
	protected $templateStructure;
	
	/**
	 * Contains a prefix for cache files
	 * @var		string
	 */
